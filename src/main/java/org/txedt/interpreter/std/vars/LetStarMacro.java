...
public class LetStarMacro extends MacroValue {
    public static @NotNull LetStarMacro macro = new LetStarMacro();
    private LetStarMacro() { }
        ...
        for (var def : varDefinitions.children) {
            switch (def) {
                ...
                case ListNode l -> {
                    ...
                    newCtx.put(s.s, Interpreter.eval(l.children.getLast(), newCtx));
                }
